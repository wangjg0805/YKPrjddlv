...
;********************************************************************************************************/
                                INCLUDE     LPC2400.INC                 ;/*  引入头文件                 */
                                                                        ;/*  定义堆栈的大小             */
SVC_STACK_LEGTH     EQU         0x1000
FIQ_STACK_LEGTH     EQU         0x1000
IRQ_STACK_LEGTH     EQU         0x1000                                   ;/*  每层嵌套需要8个字堆栈，允许*/
                                                                        ;/*  9嵌套层                    */
ABT_STACK_LEGTH     EQU         0x200
UND_STACK_LEGTH     EQU         0x200
...
WAITRD1             EQU         0x03                                    ;/* 配置EMCStaticWaitRd1        */
WAITPAGE1           EQU         0x1F                                    ;/* 配置EMCStaticWaitPage1      */
WAITWR1             EQU         0x03                                    ;/* 配置EMCStaticWaitWr1        */
WAITTURN1           EQU         0x01                                    ;/* 配置EMCStaticWaitTurn1      */
...
WAITWEN3            EQU         0x00                                    ;/* 配置EMCStaticWaitWen3       */
WAITOEN3            EQU         0x01                                    ;/* 配置EMCStaticWaitOen3       */ 
WAITRD3             EQU         0x04                                    ;/* 配置EMCStaticWaitRd3        */
WAITPAGE3           EQU         0x1F                                    ;/* 配置EMCStaticWaitPage3      */
WAITWR3             EQU         0x04                                    ;/* 配置EMCStaticWaitWr3        */
WAITTURN3           EQU         0x01                                    ;/* 配置EMCStaticWaitTurn3      */
...
STATICCFG3          EQU	  ( BCFG_08DEF | BCFG3 )
